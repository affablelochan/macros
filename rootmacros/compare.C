...
string names[4] = {"histy1","histy2","histy3","histy4","histy5"};
string pnames[4] = {"pisty1","pisty2","pisty3","pisty4","pisty5"};
string nnames[4] = {"nisty1","nisty2","nisty3","nisty4","nisty5"};
string deltaR[4] = {"0.6 < #DeltaR <1.0","1.0 < #DeltaR <1.4","1.4 < #DeltaR <1.8","1.8 < #DeltaR <2.2","2.2 < #DeltaR <2.6" };
string eps[4] = {"pt40region1.eps","pt40region2.eps","pt40region3.eps","pt40region4.eps","pt40region5.eps" };
string pdf[4] = {"pt40region1.pdf","pt40region2.pdf","pt40region3.pdf","pt40region4.pdf","pt40region5.pdf" };
string ptneigh = "p_{T}neighbour >40 GeV";
...
for (int i=0; i<5;i++)
        {
         ...
         if(i==4) {
                     R2->SetMaximum(0.023); //to set the y axis maximum
                     R2->SetMinimum(0.00); // to set the y axis minimum
                     R2->SetAxisRange(0,pi);
                   }
         else  
                   {
                      R2->SetMaximum(0.013); //to set the y axis maximum
                      R2->SetMinimum(0.00); // to set the y axis minimum
