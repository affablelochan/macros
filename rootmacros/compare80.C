...
string names[4] = {"histy111","histy112","histy113","histy114","histy115"};
string pnames[4] = {"pisty111","pisty112","pisty113","pisty114","pisty115"};
string nnames[4] = {"nisty111","nisty112","nisty113","nisty114","nisty115"};
string deltaR[4] = {"0.6 < #DeltaR <1.0","1.0 < #DeltaR <1.4","1.4 < #DeltaR <1.8","1.8 < #DeltaR <2.2","2.2 < #DeltaR <2.6" };
string eps[4] = {"pt80region1.eps","pt80region2.eps","pt80region3.eps","pt80region4.eps","pt80region5.eps" };
string pdf[4] = {"pt80region1.pdf","pt80region2.pdf","pt80region3.pdf","pt80region4.pdf","pt80region5.pdf" };
string ptneigh = "p_{T}neighbour >80 GeV";
...
for (int i=0; i<5;i++)
        {
         ...
         if(i==4) {
                     R2->SetMaximum(0.007); //to set the y axis maximum
                     R2->SetMinimum(0.00); // to set the y axis minimum
                     R2->SetAxisRange(0,pi);
                   }
         else  
                   {
                      R2->SetMaximum(0.005); //to set the y axis maximum
                      R2->SetMinimum(0.00); // to set the y axis minimum
